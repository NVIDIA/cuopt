...
inline cuopt::linear_programming::parsers::mps_data_model_t<int, double> parse_inline_mps(
  std::string_view mps_text)
{
  return cuopt::linear_programming::parsers::parse_mps_from_string<int, double>(mps_text, false);
}
