...
inline cuopt::math_optimization::io::mps_data_model_t<int, double> parse_inline_mps(
  std::string_view mps_text)
{
  return cuopt::math_optimization::io::read_mps_from_string<int, double>(mps_text, false);
}
