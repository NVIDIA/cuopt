...
cuopt::linear_programming::parsers::mps_data_model_t<int, double> read_from_mps(
  const std::string& file, bool fixed_mps_format = true)
{
  ...
  return cuopt::linear_programming::parsers::parse_mps<int, double>(rel_file, fixed_mps_format);
}
