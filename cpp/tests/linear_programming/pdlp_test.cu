...
TEST(pdlp_class, run_double)
{
  ...
  cuopt::math_optimization::io::mps_data_model_t<int, double> op_problem =
    cuopt::math_optimization::io::read_mps<int, double>(path, true);

  auto solver_settings   = pdlp_solver_settings_t<int, double>{};
  solver_settings.method = cuopt::math_optimization::method_t::PDLP;
...
TEST(pdlp_class, precision_mixed)
{
  ...
  if (!is_cusparse_runtime_mixed_precision_supported()) {
    ...
    settings.method         = cuopt::math_optimization::method_t::PDLP;
    settings.pdlp_precision = cuopt::math_optimization::pdlp_precision_t::MixedPrecision;
  ...
  settings_mixed.method         = cuopt::math_optimization::method_t::PDLP;
  settings_mixed.pdlp_precision = cuopt::math_optimization::pdlp_precision_t::MixedPrecision;
  ...
  settings_full.method         = cuopt::math_optimization::method_t::PDLP;
  settings_full.pdlp_precision = cuopt::math_optimization::pdlp_precision_t::DefaultPrecision;
...
TEST(pdlp_class, concurrent_pdlp_exception_joins_worker_threads)
{
  ...
  auto settings           = pdlp_solver_settings_t<int, double>{};
  settings.method         = cuopt::math_optimization::method_t::Concurrent;
  settings.presolver      = cuopt::math_optimization::presolver_t::None;
...
TEST(pdlp_class, run_double_very_low_accuracy)
{
  ...
  cuopt::math_optimization::pdlp_solver_settings_t<int, double> settings =
    cuopt::math_optimization::pdlp_solver_settings_t<int, double>{};
...
TEST(pdlp_class, run_time_limit)
{
  ...
  cuopt::math_optimization::io::mps_data_model_t<int, double> op_problem =
    cuopt::math_optimization::io::read_mps<int, double>(path);
...
TEST(pdlp_class, run_sub_mittleman)
{
  ...
  for (const auto& entry : instances) {
    ...
    auto solver_mode_list = {
      cuopt::math_optimization::pdlp_solver_mode_t::Stable3,
      cuopt::math_optimization::pdlp_solver_mode_t::Stable2,
      cuopt::math_optimization::pdlp_solver_mode_t::Stable1,
      cuopt::math_optimization::pdlp_solver_mode_t::Methodical1,
      cuopt::math_optimization::pdlp_solver_mode_t::Fast1,
    };
...
TEST(pdlp_class, initial_solution_test)
{
  ...
  auto path = make_path_absolute("linear_programming/afiro_original.mps");
  cuopt::math_optimization::io::mps_data_model_t<int, double> mps_data_model =
    cuopt::math_optimization::io::read_mps<int, double>(path);
  ...
  // doesn't
  solver_settings.pdlp_solver_mode = cuopt::math_optimization::pdlp_solver_mode_t::Methodical1;
  ...
  {
    cuopt::math_optimization::detail::pdlp_solver_t<int, double> solver(problem, solver_settings);
...
TEST(pdlp_class, initial_primal_weight_step_size_test)
{
  ...
  // an initial primal / dual is indeed different
  {
    ...
    cuopt::math_optimization::detail::pdlp_solver_t<int, double> solver2(problem, solver_settings);
    ...
    cuopt::math_optimization::detail::pdlp_solver_t<int, double> solver3(problem, solver_settings);
    pdlp_timer = timer_t(solver_settings.time_limit);
...
End
  ...
  solver_settings.method                               = cuopt::math_optimization::method_t::PDLP;
  solver_settings.pdlp_solver_mode = cuopt::math_optimization::pdlp_solver_mode_t::Stable2;
  set_pdlp_solver_mode(solver_settings);
...
TEST(pdlp_class, best_primal_so_far_iteration)
{
  ...
  solver_settings.method                  = cuopt::math_optimization::method_t::PDLP;
  solver_settings.pdlp_solver_mode        = cuopt::math_optimization::pdlp_solver_mode_t::Stable2;
  cuopt::math_optimization::io::mps_data_model_t<int, double> op_problem1 =
    cuopt::math_optimization::io::read_mps<int, double>(path);
  cuopt::math_optimization::io::mps_data_model_t<int, double> op_problem2 =
    cuopt::math_optimization::io::read_mps<int, double>(path);
...
TEST(pdlp_class, best_primal_so_far_time)
{
  ...
  solver_settings.per_constraint_residual = true;
  solver_settings.pdlp_solver_mode        = cuopt::math_optimization::pdlp_solver_mode_t::Stable1;
  solver_settings.method                  = cuopt::math_optimization::method_t::PDLP;
...
TEST(pdlp_class, batch_per_constraint_residual_different_rhs_stable3)
{
  ...
  auto climber0_problem = cuopt::math_optimization::io::read_mps<int, double>(path);
  auto climber1_problem = cuopt::math_optimization::io::read_mps<int, double>(path);
...
TEST(pdlp_class, all_primal_feasible_and_per_constraint_residual_batch_many_different_rhs_stable3_1)
{
  ...
  std::vector<cuopt::math_optimization::io::mps_data_model_t<int, double>> ref_problems;
...
TEST(pdlp_class, warm_start)
{
  ...
  for (auto instance_name : instance_names) {
    ...
    cuopt::math_optimization::io::mps_data_model_t<int, double> mps_data_model =
      cuopt::math_optimization::io::read_mps<int, double>(path);
    auto op_problem1 =
      cuopt::math_optimization::mps_data_model_to_optimization_problem<int, double>(&handle,
                                                                                    mps_data_model);
...
TEST(pdlp_class, warm_start_stable3_not_supported)
{
  ...
  auto path                        = make_path_absolute("linear_programming/afiro_original.mps");
  auto solver_settings             = pdlp_solver_settings_t<int, double>{};
  solver_settings.pdlp_solver_mode = cuopt::math_optimization::pdlp_solver_mode_t::Stable3;
  solver_settings.set_optimality_tolerance(1e-2);
  solver_settings.detect_infeasibility = false;
  solver_settings.method               = cuopt::math_optimization::method_t::PDLP;
  solver_settings.presolver            = presolver_t::None;
...
TEST(pdlp_class, run_empty_matrix_dual_simplex)
{
  ...
  auto solver_settings      = pdlp_solver_settings_t<int, double>{};
  solver_settings.method    = cuopt::math_optimization::method_t::Concurrent;
  solver_settings.presolver = presolver_t::None;
...
TEST(pdlp_class, run_batch_pdlp_fixed_rejects_partial_per_climber_expansion)
{
  ...
  auto make_settings = []() {
    ...
    s.method                              = cuopt::math_optimization::method_t::PDLP;
  ...
  {
    auto gpu_op = cuopt::math_optimization::mps_data_model_to_optimization_problem<int, double>(
      &handle_, op_problem);
    ...
    expect_validation_error([&]() { cuopt::math_optimization::run_batch_pdlp(gpu_op, settings); });
  }
...
TEST(pdlp_class, run_batch_pdlp_rejects_invalid_new_bounds)
{
  ...
  auto expect_validation_error = [&](pdlp_solver_settings_t<int, double> settings) {
    auto gpu_op = cuopt::math_optimization::mps_data_model_to_optimization_problem<int, double>(
      &handle_, op_problem);
    try {
      cuopt::math_optimization::run_batch_pdlp(gpu_op, settings);
      FAIL() << "expected cuopt::logic_error with ValidationError";
    } catch (const cuopt::logic_error& e) {
      EXPECT_EQ(e.get_error_type(), cuopt::error_type_t::ValidationError);
    }
...
TEST(pdlp_class, run_batch_pdlp_rejects_save_best_primal_so_far)
{
  ...
  // Splitting path: trigger batch mode via a non-empty new_bounds list (size > 1).
  {
    ...
    auto sol = cuopt::math_optimization::run_batch_pdlp(gpu_op, settings);
    EXPECT_EQ(sol.get_error_status().get_error_type(), cuopt::error_type_t::ValidationError);
  }
...
TEST(pdlp_class, strong_branching_test)
{
  ...
  solver_settings.method                              = cuopt::math_optimization::method_t::PDLP;
  solver_settings.pdlp_solver_mode                    = pdlp_solver_mode_t::Stable3;
  solver_settings.presolver                           = cuopt::math_optimization::presolver_t::None;
...
TEST(pdlp_class, strong_branching_user_api)
{
  ...
  auto gpu_op = cuopt::math_optimization::mps_data_model_to_optimization_problem<int, double>(
    &handle_, op_problem);
  auto batch_sol = cuopt::math_optimization::run_batch_pdlp(gpu_op, solver_settings);
...
TEST(pdlp_class, run_batch_pdlp_many_different_bounds)
{
  ...
  regular_pdlp_settings.method           = cuopt::math_optimization::method_t::PDLP;
...
TEST(pdlp_class, run_batch_fixed_api_many_different_bounds_good_mps_some_var_bounds)
{
  ...
  auto gpu_op = cuopt::math_optimization::mps_data_model_to_optimization_problem<int, double>(
    &handle_, op_problem);
  auto batch_solution = cuopt::math_optimization::run_batch_pdlp(gpu_op, batch_settings);
...
TEST(pdlp_class, precision_single)
{
  ...
  auto solver_settings           = pdlp_solver_settings_t<int, double>{};
  solver_settings.method         = cuopt::math_optimization::method_t::PDLP;
  solver_settings.pdlp_precision = cuopt::math_optimization::pdlp_precision_t::SinglePrecision;
...
TEST(pdlp_class, precision_single_papilo_presolve)
{
  ...
  solver_settings.method         = cuopt::math_optimization::method_t::PDLP;
  solver_settings.pdlp_precision = cuopt::math_optimization::pdlp_precision_t::SinglePrecision;
  solver_settings.presolver      = cuopt::math_optimization::presolver_t::Papilo;
...
TEST(pdlp_class, precision_single_pslp_presolve)
{
  ...
  solver_settings.method         = cuopt::math_optimization::method_t::PDLP;
  solver_settings.pdlp_precision = cuopt::math_optimization::pdlp_precision_t::SinglePrecision;
  solver_settings.presolver      = cuopt::math_optimization::presolver_t::PSLP;
...
TEST(pdlp_class, shared_sb_view_concurrent_mark)
{
  ...
  for (int i = 0; i < batch_size; ++i) {
    ...
    EXPECT_TRUE(status == pdlp_termination_status_t::Optimal ||
      ...
      << cuopt::math_optimization::optimization_problem_solution_t<int, double>::
...
TEST(pdlp_class, big_batch_fixed_path)
{
  ...
  const size_t batch_size =
    cuopt::math_optimization::compute_optimal_batch_size(gpu_op, true, true, true);
  ...
  auto solution = cuopt::math_optimization::run_batch_pdlp(gpu_op, solver_settings);
...
TEST(pdlp_class, batch_bound_objective_rescaling_factors_match_input_expansion)
{
  ...
  auto compute_rescaling = [&](std::vector<double> const& objectives,
    ...
    cuopt::math_optimization::detail::pdlp_initial_scaling_strategy_t<int, double> scaling(
      &handle_,
      problem,
