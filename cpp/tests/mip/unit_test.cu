...
End
  ...
  EXPECT_EQ(result.get_termination_status(),
            cuopt::math_optimization::pdlp_termination_status_t::Optimal);
...
TEST(ErrorTest, TestError)
{
  ...
  EXPECT_EQ(result.get_termination_status(),
            cuopt::math_optimization::mip_termination_status_t::NoTermination);
}

class MILPTestParams
  : public testing::TestWithParam<
      std::tuple<bool, int, bool, cuopt::math_optimization::mip_termination_status_t>> {};
