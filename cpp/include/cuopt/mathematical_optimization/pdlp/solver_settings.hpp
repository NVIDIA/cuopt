...
class pdlp_solver_settings_t {
 public:
  ...
  // TODO: Remove this cutoff once Barrier memory usage and cuDSS long running kernels are resolved.
  // -1 disables the cutoff and enables Barrier regardless of the reduced problem's NNZ.
