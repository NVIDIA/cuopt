...
#include <cuopt/math_optimization/mip/solver_solution.hpp>  // For mip_termination_status_t
#include <cuopt/math_optimization/pdlp/pdlp_warm_start_data.hpp>
#include <cuopt/math_optimization/pdlp/solver_solution.hpp>  // For pdlp_termination_status_t
