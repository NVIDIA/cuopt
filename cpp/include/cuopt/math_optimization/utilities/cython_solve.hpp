...
#include <cuopt/math_optimization/optimization_problem_solution_interface.hpp>
#include <cuopt/math_optimization/solver_settings.hpp>
#include <cuopt/math_optimization/utilities/cython_types.hpp>
...
struct solver_ret_t {
  math_optimization::problem_category_t problem_type;
...
math_optimization::lp_solution_interface_t<int, double>* call_solve_lp(
  math_optimization::optimization_problem_interface_t<int, double>* problem_interface,
  math_optimization::pdlp_solver_settings_t<int, double>& solver_settings,
  bool is_batch_mode = false);

// Call solve_mip and return solution interface pointer
math_optimization::mip_solution_interface_t<int, double>* call_solve_mip(
  math_optimization::optimization_problem_interface_t<int, double>* problem_interface,
  math_optimization::mip_solver_settings_t<int, double>& solver_settings);

// Main solve entry point from Python
std::unique_ptr<solver_ret_t> call_solve(
  cuopt::math_optimization::io::data_model_view_t<int, double>*,
  math_optimization::solver_settings_t<int, double>*,
  unsigned int flags = cudaStreamNonBlocking,
  bool is_batch_mode = false);

std::pair<std::vector<std::unique_ptr<solver_ret_t>>, double> solve_batch_remote(
  std::vector<cuopt::math_optimization::io::data_model_view_t<int, double>*>,
  math_optimization::solver_settings_t<int, double>*);
