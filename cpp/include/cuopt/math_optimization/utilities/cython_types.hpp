...
struct linear_programming_ret_t {
  ...
  math_optimization::pdlp_termination_status_t termination_status_{};
  ...
  int nb_iterations_{};
  double solve_time_{};
  math_optimization::method_t solved_by_{};
...
struct mip_ret_t {
  ...
  math_optimization::mip_termination_status_t termination_status_{};
  error_type_t error_status_{};
  std::string error_message_;
