...
HEADER = """\
// ============================================================================
// AUTO-GENERATED by codegen/generate_conversions.py from field_registry.yaml
...
def _field_result_id_name(f):
    """Derive ResultFieldId enum name from field name: RESULT_{UPPER_SNAKE(name)}."""
...
def generate_data_proto(registry):
    ...
    parts = [
        "// AUTO-GENERATED by codegen/generate_conversions.py from field_registry.yaml",
        "// DO NOT EDIT — regenerate with: python cpp/codegen/generate_conversions.py",
        "",
        'syntax = "proto3";',
        "",
...
def _gen_chunked_to_solution(registry, obj_name, obj, indent="  "):
    ...
    if ws:
        ...
        detect_eid = (
            _field_result_id_name(first_array) if first_array else None
        )
        lines.append("")
        lines.append(
