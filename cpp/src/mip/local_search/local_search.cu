...
{
  // CUOPT_LOG_DEBUG(
  //   "best overall: %g/%g", pop_ptr->best_feasible().get_objective(), local_search_best_obj);
  ...
  //     scratch_cpu_fj[1].fj_ptr->create_cpu_climber(pop_ptr->best_feasible(),
  //                                                  default_weights,
  //                                                  default_weights,
  //                                                  0.,
  //                                                  fj_settings_t{},
  ...
  //   scratch_cpu_fj[1].fj_cpu->log_prefix           = "******* scratch restard: ";
