...
solver_settings_t<i_t, f_t>::solver_settings_t() : pdlp_settings(), mip_settings()
{
  ...
  float_parameters = {
    ...
    {CUOPT_BARRIER_RELATIVE_FEASIBILITY_TOLERANCE, &pdlp_settings.barrier_relative_feasibility_tolerance, f_t(0.0), f_t(1e-1), f_t(1e-8)},
    {CUOPT_BARRIER_RELATIVE_OPTIMALITY_TOLERANCE, &pdlp_settings.barrier_relative_optimality_tolerance, f_t(0.0), f_t(1e-1), f_t(1e-8)},
    {CUOPT_BARRIER_RELATIVE_COMPLEMENTARITY_TOLERANCE, &pdlp_settings.barrier_relative_complementarity_tolerance, f_t(0.0), f_t(1e-1), f_t(1e-8)},
  ...
  bool_parameters = {
    ...
    {CUOPT_BARRIER_PRESOLVE, &pdlp_settings.barrier_presolve, true},
    {CUOPT_BARRIER_NATIVE_FREE_LINEAR, &pdlp_settings.barrier_native_free_linear, true},
  };
  // String parameters
  string_parameters = {
