...
solver_settings_t<i_t, f_t>::solver_settings_t() : pdlp_settings(), mip_settings()
{
  ...
  int_parameters = {
    ...
    {CUOPT_BNB_SEARCH_STRATEGY, reinterpret_cast<int*>(&mip_settings.bnb_search_strategy), CUOPT_BNB_SEARCH_STRATEGY_BEST_FIRST, CUOPT_BNB_SEARCH_STRATEGY_MULTITHREADED_BEST_FIRST_WITH_DIVING, CUOPT_BNB_SEARCH_STRATEGY_BEST_FIRST}
  };
