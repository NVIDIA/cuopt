...
void compute_row_inf_norm(
  const cuopt::math_optimization::optimization_problem_t<i_t, f_t>& op_problem,
...
template <typename i_t, typename f_t>
void scale_objective(cuopt::math_optimization::optimization_problem_t<i_t, f_t>& op_problem)
{
...
template <typename i_t, typename f_t>
size_t dry_run_cub(const cuopt::math_optimization::optimization_problem_t<i_t, f_t>& op_problem,
                   i_t n_rows,
                   rmm::device_uvector<f_t>& row_inf_norm,
                   rmm::device_uvector<f_t>& row_min_nonzero,
                   rmm::device_uvector<i_t>& row_nonzero_count,
