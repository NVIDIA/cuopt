...
// phase begins. Consumers may read it after an acquire load of `*complete`
// returns true. Otherwise they MUST set `*signal_extend` and join the producing
// task before reading it, since extension keeps mutating the published object.
template <typename i_t, typename f_t>
