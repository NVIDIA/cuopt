  ...
  i_t num_cpu_threads)
{
  ...
  if (category == problem_category_t::MIP &&
      presolver == cuopt::math_optimization::presolver_t::PSLP) {
    cuopt_expects(
      false, error_type_t::RuntimeError, "PSLP presolver is not supported for MIP problems");
  }

  if (presolver == cuopt::math_optimization::presolver_t::PSLP) {
...
{
  if (presolver_ == cuopt::math_optimization::presolver_t::PSLP) {
