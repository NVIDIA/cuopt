...
optimization_problem_solution_t<i_t, f_t> batch_pdlp_solve(
  ...
  const cuopt::linear_programming::parsers::mps_data_model_t<i_t, f_t>& mps_model,
...
cuopt::linear_programming::optimization_problem_t<i_t, f_t> mps_data_model_to_optimization_problem(
  raft::handle_t const* handle_ptr,
  const cuopt::linear_programming::parsers::mps_data_model_t<i_t, f_t>& data_model)
{
...
#define INSTANTIATE(F_TYPE)                                                                      \
  ...
  template optimization_problem_t<int, F_TYPE> mps_data_model_to_optimization_problem(           \
    raft::handle_t const* handle_ptr,                                                            \
    const cuopt::linear_programming::parsers::mps_data_model_t<int, F_TYPE>& data_model);                         \  template void set_pdlp_solver_mode(pdlp_solver_settings_t<int, F_TYPE>& settings);
