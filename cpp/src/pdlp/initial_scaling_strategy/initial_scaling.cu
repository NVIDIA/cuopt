...
__global__ void inf_norm_row_and_col_kernel(
  const typename detail::problem_t<i_t, f_t>::view_t op_problem,
...
template <typename i_t, typename f_t>
void pdlp_initial_scaling_strategy_t<i_t, f_t>::unscale_solutions(
  detail::solution_t<i_t, f_t>& solution) const
{
...
pdlp_initial_scaling_strategy_t<i_t, f_t>::get_scaled_op_problem()
{
...
#define INSTANTIATE(F_TYPE)                                                                   \
  ...
  template __global__ void inf_norm_row_and_col_kernel<int, F_TYPE>(                          \
    const typename detail::problem_t<int, F_TYPE>::view_t op_problem,                         \
