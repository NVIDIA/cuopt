...
template <typename i_t, typename f_t>
cpu_optimization_problem_t<i_t, f_t>::cpu_optimization_problem_t(
  const cpu_optimization_problem_t<i_t, f_t>& other)
...
template <typename i_t, typename f_t>
cpu_optimization_problem_t<i_t, f_t>::cpu_optimization_problem_t(
  cpu_optimization_problem_t<i_t, f_t>&& other) noexcept = default;

template <typename i_t, typename f_t>
cpu_optimization_problem_t<i_t, f_t>& cpu_optimization_problem_t<i_t, f_t>::operator=(
  const cpu_optimization_problem_t<i_t, f_t>& other)
{
...
template <typename i_t, typename f_t>
cpu_optimization_problem_t<i_t, f_t>::~cpu_optimization_problem_t() = default;
