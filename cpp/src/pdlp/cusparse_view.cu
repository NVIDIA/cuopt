...
//
// `cusparse_spmvop_buffer_size` and `cusparse_spmvop_create_descr` dispatch
// between the cuSPARSE 12.7 and 12.8 signatures at runtime (cuSPARSE 12.8 added
// a `cusparseSpMVOpAlg_t` parameter), since the compiled headers may not match
// the runtime cuSPARSE version.
