...
# Single source for the "don't hand-edit this" notice every generated file
# carries. Previously duplicated by hand between HEADER (below, used by the
# .inc files) and the .proto header -- they'd drifted to different wording
# and commands. Both are now built from these two lines.
_GENERATED_NOTICE = (
...
def generate_data_proto(registry):
    ...
    parts = [
        *(f"// {line}" for line in _GENERATED_NOTICE),
        "",
        'syntax = "proto3";',
        "",
