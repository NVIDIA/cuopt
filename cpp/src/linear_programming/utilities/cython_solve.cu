  ...
  bool is_batch_mode)
{
  ...
  // This is a workaround to fix the synchronization issues, please fix this in the future and remove this workaround.
  // cudaStream_t stream;
  // RAFT_CUDA_TRY(cudaStreamCreateWithFlags(&stream, flags));  // flags=cudaStreamNonBlocking
