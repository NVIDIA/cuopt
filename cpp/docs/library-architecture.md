...
>
> For the runtime design of the gRPC server (processes, shared memory, pipes) see
> `cpp/docs/grpc-server-architecture.md`. This document is about the *build* structure: which
> artifact holds which code, and what that implies.
