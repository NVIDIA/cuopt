...
There are two options: - NVIDIA Docker Hub (<https://hub.docker.com/r/nvidia/cuopt>) - NVIDIA NGC registry (<https://catalog.ngc.nvidia.com/orgs/nvidia/cuopt/containers/cuopt/tags>) with an NVAIE license or NVIDIA Developer Program membership.
