---
title: "Build Your Own Self-Hosted Thin Client"
---
...
`JSON_DATA` should follow the [spec under "POST /cuopt/request" schema](../../open-api) described for cuOpt input.
...
Please refer to the [Solver status in spec using "GET /cuopt/request/{request-id}"](../../open-api) for more details on responses.
...
This would fetch the result in JSON format. Please refer to the [Response structure in spec using "GET /cuopt/solution/{request-id}"](../../open-api) for more details on responses.
