...
```c
#include <cuopt/math_optimization/cuopt_c.h>   // Core API
#include <cuopt/math_optimization/constants.h> // Parameter name macros (CUOPT_TIME_LIMIT, etc.)
```
...
> **Complete list:** See `cpp/include/cuopt/math_optimization/constants.h` for all 50+ parameter constants including termination status codes, constraint senses, and file format constants.
...
| Resource | Location |
|----------|----------|
| **Constants Header** | `cpp/include/cuopt/math_optimization/constants.h` |
| C API Header | `cpp/include/cuopt/math_optimization/cuopt_c.h` |
