...
```cython
cdef extern from "cuopt/math_optimization/solver_settings.hpp" namespace "cuopt::math_optimization":
    ctypedef enum pdlp_solver_mode_t "cuopt::math_optimization::pdlp_solver_mode_t":
        Stable1 "cuopt::math_optimization::pdlp_solver_mode_t::Stable1"
        Stable2 "cuopt::math_optimization::pdlp_solver_mode_t::Stable2"
