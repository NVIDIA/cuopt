...
The user may specify a maximum number of branch-and-bound nodes via ``node_limit``.
The solver stops once this limit is reached and returns the current best feasible
