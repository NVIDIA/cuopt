...
#   CUOPT_TEST_LABELS=mathopt          — run all LP/MIP/QP/dual-simplex/parser tests
#   CUOPT_TEST_LABELS=mip              — run only MIP tests
#   CUOPT_TEST_LABELS=routing,mathopt  — run routing + mathopt tests
#
# Available labels: routing, mathopt (includes lp, mip, qp, parser), grpc, cli
#
