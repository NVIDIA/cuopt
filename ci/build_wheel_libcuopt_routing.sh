...
package_name="libcuopt_routing"
package_dir="python/libcuopt_routing"
...
RAPIDS_PACKAGE_NAME="$(rapids-artifact-name wheel_cpp libcuopt_routing cuopt --cuda "$RAPIDS_CUDA_VERSION")"
