...
cuopt-sh-client @ file://$(echo ${CUOPT_SH_CLIENT_WHEELHOUSE}/cuopt_sh_client_*.whl)
cuopt-${RAPIDS_PY_CUDA_SUFFIX} @ file://$(echo ${LIBCUOPT_WHEELHOUSE}/cuopt_${RAPIDS_PY_CUDA_SUFFIX}_*.whl)
EOF
